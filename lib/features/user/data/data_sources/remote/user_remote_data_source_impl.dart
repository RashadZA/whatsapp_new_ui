...
import 'package:whatsapp_new_ui/features/user/data/models/user_model.dart';
import 'package:whatsapp_new_ui/features/user/domain/entities/contact_entity.dart';
...
class UserRemoteDataSourceImpl implements UserRemoteDataSource {
  ...
  Future<void> verifyPhoneNumber(String phoneNumber) async  {
    ...
    phoneVerificationCompleted(AuthCredential authCredential) {
      debugPrint("phone verified : Token ${authCredential.token} ${authCredential.signInMethod}");
    }
